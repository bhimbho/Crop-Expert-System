                ...
                <div class="row">
                    ...
                    <?php
                        if(isset($_POST['add'])){
                                ...
                                if($disease->add_inference($_POST['solution'],$_POST['disease_id'])){
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <select name="disease_id" class="form-control">
                                ...
                                <?php
                                    $disease_list = $disease->all_disease();
                                    foreach ($disease_list as $disease_list) {?>
                                        <option value="<?= $disease_list->disease_id ?>"><?= $disease_list->disease ?></option>
                                    <?php }?>
                           </select>
                        </div>
                        <div class="form-group">
                    ...
                    <tbody>
                        ...
                        if(is_array($all_content)){
                            foreach ($all_content as $all_content) {?>
                                ...
                                <td><a class="btn btn-info" href="edit_disease_inference.php?solution_id=<?= $all_content->solution_id?>">Edit</a> <a class="btn btn-danger" href="api/delete-inference.php?solution_id=<?= $all_content->solution_id?>">Delete</a></td>
                            </tr>
                        <?php }}?>
                    </tbody>
                </table>
