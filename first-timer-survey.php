		...
		<div class="row expert">
			...
			<div class="col-md-8 d-flex align-items-center flex-column justify-content-center">
				...
				<form method="post" class="w-75 text-center">
                    ...
                    <div class="form-group">
                        <button class="btn btn-warning rounded-0 next btn-block">Next</button>
                  </div>
                  <div class="form-group">
                      <button class="finish">Finish</button></div>
                  </div>
                  <div class="question">
                    ...
                    <button class="btn btn-warning rounded-0 btn-block next">Next</button>
